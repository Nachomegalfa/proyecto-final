...
router.post("/update", (0, express_async_handler_1["default"])(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, id, direcciones, tarjetas, response;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                console.log("entro aqui");
                _a = req.body, id = _a.id, direcciones = _a.direcciones, tarjetas = _a.tarjetas;
                return [4 /*yield*/, user_model_1.UserModel.updateOne({ direcciones: direcciones, tarjetas: tarjetas }, {
                        where: {
                            id: id
                        }
                    })];
...
router.post("/login", (0, express_async_handler_1["default"])(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, guess, user;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                guess = _b.sent();
                return [4 /*yield*/, user_model_1.UserModel.findOne({ email: email, guess: guess })];
            case 2:
                user = _b.sent();
                if (user) {
...
router.post("/register", (0, express_async_handler_1["default"])(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, nombre, apellidos, email, password, fechaNacimiento, user, encryptedPassword, newUser, dbUser;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, nombre = _a.nombre, apellidos = _a.apellidos, email = _a.email, password = _a.password, fechaNacimiento = _a.fechaNacimiento;
